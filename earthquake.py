#this project aims to create a map of earthquakes in haiti using the dataset from ushadidi and
#instructions from Wes Mckinney's Python for Data Analysis
